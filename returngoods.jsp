	 ...
	 <%@ include file="adminlist.jsp" %>
		<div class="m-right">
			<div class="right-nav">
					<ul>
							<li></li>
								...
								<li>></li>
								<li><a href="returngoods.jsp">用户请求管理-退货处理</a></li>
						</ul>
		 ...
		 <%      
            ...
            if(orderID!=null){ 
            String sqlu="update orderbasic set zhuangtai='失败交易' where orderid='"+orderID+"'";		
			stmt.executeUpdate(sqlu);
           }
		    String sqls="select orderbasic.orderid,riqi,bookid,bookname,num,zhuangtai,name,phone,address   from orderbasic,orderdetails where orderbasic.orderid=orderdetails.orderid and zhuangtai='退货中'";			
       ...
       <th>订单号</th>
        ...
        <th>操作</th>    
         ...
         <%    do{ if(count>=pagesize)break;
             ...
             <td ><%=zhuangtai%></td>
             <td>
              <a href="returngoods.jsp?orderid=<%=orderid%>&bookid=<%=bookid%>">退货</a>
             </td>
             </tr>
               <% 
                }while(rs.next()); 
           ...
           %>
            ...
            <a href = "returngoods.jsp?curPage=1" >首页</a>  
            <a href = "returngoods.jsp?curPage=<%=curPage-1%>" >上一页</a>  
            <a href = "returngoods.jsp?curPage=<%=curPage+1%>" >下一页</a>  
            <a href = "returngoods.jsp?curPage=<%=pageCount%>" >尾页</a>  
