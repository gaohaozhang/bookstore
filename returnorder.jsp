...
<div id="body">
    ...
    <div id="container">
	    ...
	    <dd><a href="order.jsp">订单查看</a></dd>
	     <dd><a href="returnorder.jsp">退货请求</a></dd>
   ...
   <div>进入：<a class="f16" href="message.jsp">talking@miao.com</a></div>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt><h1><em></em><a href="returnorder.jsp">退货请求</a></h1></dt>
       ...
       <% 
            ...
            String sqlu="update orderbasic set zhuangtai='退货中' where orderid='"+orderID+"'";		
			stmt.executeUpdate(sqlu);
           }
		    String sqls="select orderbasic.orderid,riqi,bookid,bookname,num,sums,zhuangtai   from orderbasic,orderdetails where orderbasic.orderid=orderdetails.orderid and tel='"+ session.getAttribute("phone")+"'and zhuangtai IN('已发货','退货中')";		
       ...
       <th>日期</th>
        ...
        <th>操作</th>
         ...
         <%   
             ...
             <td ><%=zhuangtai%></td>   
             <td>
              <a href="returnorder.jsp?orderid=<%=orderid%>&bookid=<%=bookid%>">退货</a>
             </td>
           ...
           %>
            ...
            <a href = "order.jsp?curPage=1" >首页</a>  
            <a href = "order.jsp?curPage=<%=curPage-1%>" >上一页</a>  
            <a href = "order.jsp?curPage=<%=curPage+1%>" >下一页</a>  
            <a href = "order.jsp?curPage=<%=pageCount%>" >尾页</a>  
