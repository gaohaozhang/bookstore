...
<div id="content">
	 <%@ include file="adminlist.jsp" %>
		<div class="m-right">
			...
			<div class="main">
		 <ul> <li>订单号：</li>
		    <form  name="form1" action="sussorder1.jsp"method="post" >
		    ...
		    String sqls="select orderbasic.orderid,riqi,bookid,bookname,num,zhuangtai,name,phone,address   from orderbasic,orderdetails where orderbasic.orderid=orderdetails.orderid and zhuangtai='成功交易'  ";			
