...
<div id="content">
	 <%@ include file="adminlist.jsp" %>
		<div class="m-right">
			<div class="right-nav">
					<ul>
							<li></li>
								...
								<li>></li>
								<li><a href="succq.jsp">订单管理-已发货</a></li>
						</ul>
			...
			<div class="main">
		 <ul> <li>订单号：</li>
		    <form  name="form1" action="succq1.jsp"method="post" >
		      <input type="text" id="id" name="id">
		      <input style="color:#fff;"type="submit" class="submitLogin"  value="确认成功交易" />
		      </form></ul> 
		    ...
		    String sqls="select orderbasic.orderid,riqi,bookid,bookname,num,zhuangtai,name,phone,address   from orderbasic,orderdetails where orderbasic.orderid=orderdetails.orderid and zhuangtai='已发货'  ";			
        ...
        <th>状态</th>      
         ...
         <%    do{ if(count>=pagesize)break;
           ...
           %>
            ...
            <a href = "succq.jsp?curPage=1" >首页</a>  
            <a href = "succq.jsp?curPage=<%=curPage-1%>" >上一页</a>  
            <a href = "succq.jsp?curPage=<%=curPage+1%>" >下一页</a>  
            <a href = "succq.jsp?curPage=<%=pageCount%>" >尾页</a>  
