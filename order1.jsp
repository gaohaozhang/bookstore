...
<div id="body">
   ...
   <div>进入：<a class="f16" href="message.jsp">talking@miao.com</a></div>
       ...
       <%   session.getAttribute("phone"); 
		    ...
		    String sqls="select orderbasic.orderid,riqi,bookid,bookname,num,sums,zhuangtai   from orderbasic,orderdetails where orderbasic.orderid=orderdetails.orderid and tel='"+ session.getAttribute("phone")+"'and zhuangtai='待发货'";			
        ...
        <th>状态</th>
         ...
         <%    do{ if(count>=pagesize)break;
           ...
           %>
            ...
            <a href = "order1.jsp?curPage=1" >首页</a>  
            <a href = "order1.jsp?curPage=<%=curPage-1%>" >上一页</a>  
            <a href = "order1.jsp?curPage=<%=curPage+1%>" >下一页</a>  
            <a href = "order1.jsp?curPage=<%=pageCount%>" >尾页</a>  
