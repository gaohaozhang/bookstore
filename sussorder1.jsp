...
<div id="content">
	 <%@ include file="adminlist.jsp" %>
		<div class="m-right">
			<div class="right-nav">
					<ul>
							<li></li>
								...
								<li>></li>
								<li><a href="sussorder.jsp">订单管理-成功订单</a></li>
						</ul>
            ...
            String sqls="select orderbasic.orderid,riqi,bookid,bookname,num,zhuangtai,name,phone,address   from orderbasic,orderdetails where orderbasic.orderid=orderdetails.orderid and zhuangtai='成功交易'and orderbasic.orderid='"+orderID+"'";	
        ...
        <th>状态</th>      
         ...
         <%    do{ if(count>=pagesize)break;
           ...
           %>
            ...
            <a href = "sussorder1.jsp?curPage=1" >首页</a>  
            <a href = "sussorder1.jsp?curPage=<%=curPage-1%>" >上一页</a>  
            <a href = "sussorder1.jsp?curPage=<%=curPage+1%>" >下一页</a>  
            <a href = "sussorder1.jsp?curPage=<%=pageCount%>" >尾页</a>  
