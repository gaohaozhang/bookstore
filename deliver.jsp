...
<div id="content">
	 <%@ include file="adminlist.jsp" %>
		<div class="m-right">
			<div class="right-nav">
					<ul>
							<li></li>
								...
								<li>></li>
								<li><a href="returngoods.jsp">用户请求管理-发货处理</a></li>
						</ul>
		    ...
		    String sqls="select orderbasic.orderid,riqi,bookid,bookname,num,zhuangtai,name,phone,address   from orderbasic,orderdetails where orderbasic.orderid=orderdetails.orderid and zhuangtai='待发货'  ";			
       ...
       <th>订单号</th>
        ...
        <th>状态</th>
         ...
         <%    do{ if(count>=pagesize)break;
             ...
             <td ><%=zhuangtai%></td>
             <td>
              <a href="deliver.jsp?orderid=<%=orderid%>">发货</a>
             </td>
             </tr>
               <% 
                }while(rs.next()); 
           ...
           %>
            ...
            <a href = "deliver.jsp?curPage=1" >首页</a>  
            <a href = "deliver.jsp?curPage=<%=curPage-1%>" >上一页</a>  
            <a href = "deliver.jsp?curPage=<%=curPage+1%>" >下一页</a>  
            <a href = "deliver.jsp?curPage=<%=pageCount%>" >尾页</a>  
