   ...
   <div>进入：<a class="f16" href="message.jsp">talking@miao.com</a></div>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt><h1><em></em>订单查看-<em></em>  <a href="order1.jsp">待发货-</a> <a href="order2.jsp">待收货</a></h1></dt>
                 <dd>
       <%   session.getAttribute("phone"); 
		    ...
		    String sqls="select orderbasic.orderid,riqi,bookid,bookname,num,sums,zhuangtai   from orderbasic,orderdetails where orderbasic.orderid=orderdetails.orderid and tel='"+ session.getAttribute("phone")+"'";			
