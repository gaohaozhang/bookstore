	...
	<div class="login_wrapper">
    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
        	...
        	<form id="loginForm" name="form1" action="adminpsw1.jsp"method="post" onsubmit="return checkpsw();">
			<input type="text" id="tel" name="userpassword" value="请输入密码"  onfocus="this.value=''" onblur="if(this.value==''){this.value='请输入密码'}"  />			
			<input type="text" id="password" name="userpassword2" value="请再次输入密码"  onChange="checkpsw()" onfocus="this.value=''" onblur="if(this.value==''){this.value='请输入密码'}" />	
