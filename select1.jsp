        ...
        <th>价格</th>
         ...
         <%    do{ if(count>=pagesize)break;
           ...
           %>
            ...
            <a href = "select1.jsp?curPage=1" >首页</a>  
            <a href = "select1.jsp?curPage=<%=curPage-1%>" >上一页</a>  
            <a href = "select1.jsp?curPage=<%=curPage+1%>" >下一页</a>  
            <a href = "select1.jsp?curPage=<%=pageCount%>" >尾页</a>  
